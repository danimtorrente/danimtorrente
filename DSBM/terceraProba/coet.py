...
simul_time = 20000 # 1 hora 

temps_treball = simul_time/2
temps_treballant = 0
...
m_comb = 900000      # kg massa de combustible  
...
def PlotAll():
    ...
    ax1.plot([0,simul_time],[Altin+10000000,Altin+10000000],'k--', lw=2)
    ...
    plot.show()                         #pinta grafica                     #pinta grafica
...
def Controla_Coet (t_act,consigna):  
    ...
    global error_anterior, integral, temps_treballant
